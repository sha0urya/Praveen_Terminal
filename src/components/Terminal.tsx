...
export const commands: Command = [
  { cmd: "about", desc: "about praveen", tab: 8 },
  { cmd: "clear", desc: "clear the terminal", tab: 8 },
  { cmd: "echo", desc: "print out anything", tab: 9 },
  { cmd: "education", desc: "my education background", tab: 4 },
  { cmd: "experience", desc: "my experience background", tab: 3 },
  { cmd: "projects", desc: "view projects that I've coded", tab: 5 },
  { cmd: "skills", desc: "my skills", tab: 7 },
  { cmd: "positions", desc: "my positions of responsibilities", tab: 4 },
  { cmd: "achievements", desc: "my achievements", tab: 1 },
